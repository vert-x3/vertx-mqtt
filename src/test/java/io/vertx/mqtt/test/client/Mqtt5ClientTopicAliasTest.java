  ...
  public void firstPublishCarriesTopicNameAndAlias(TestContext ctx) {
    ...
    server.endpointHandler(endpoint -> {
      ...
      endpoint.publishHandler(msg -> {
        ...
        MqttProperties.MqttProperty<?> aliasProp = msg.properties().getProperty(MqttProperties.MqttPropertyType.TOPIC_ALIAS.value());
  ...
  public void topicAliasDisabledWhenServerSaysZero(TestContext ctx) {
    ...
    server.endpointHandler(endpoint -> {
      ...
      endpoint.publishHandler(msg -> {
        ...
        ctx.assertNull(msg.properties().getProperty(MqttProperties.MqttPropertyType.TOPIC_ALIAS.value()));
        serverReceived.complete();
      });
    });
