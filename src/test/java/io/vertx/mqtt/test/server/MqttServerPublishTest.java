...
public class MqttServerPublishTest extends MqttServerBaseTest {
  ...
  protected void endpointHandler(MqttEndpoint endpoint, TestContext context) {
    ...
    endpoint.subscribeHandler(subscribe -> {
      ...
      String topicName = subscribe.topicSubscriptions().get(0).topicName();
      MqttQoS qosLevel = subscribe.topicSubscriptions().get(0).qualityOfService();
      ...
      endpoint.publish(this.topic, Buffer.buffer(this.message), qosLevel, false, false)
