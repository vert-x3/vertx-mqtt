...
public class MqttClientOptions extends NetClientOptions {
  ...
  public static final long DEFAULT_INITIAL_CONNECTION_TIMEOUT = 20_000;
  ...
  private long connectionTimeout = DEFAULT_INITIAL_CONNECTION_TIMEOUT;
  ...
  /**
   * The timeout to cancel the connection on client-side if the server did not respond with a CONNACK message within
   * the given amount of time.
   *
   * @return the initial connection timeout in milliseconds
   */
   ...
   *
   * @param connectionTimeout the initial connection timeout in milliseconds
   * @return current options instance
   */
  public MqttClientOptions setConnectionTimeout(long connectionTimeout) {
