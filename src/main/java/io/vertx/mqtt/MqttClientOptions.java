...
public class MqttClientOptions extends NetClientOptions {
  ...
  /**
   * @deprecated use {@link #DEFAULT_KEEP_ALIVE_INTERVAL}
   */
  @Deprecated
  public static final int DEFAULT_KEEP_ALIVE_TIME_SECONDS = DEFAULT_KEEP_ALIVE_INTERVAL;
  ...
  /**
   * @deprecated instead use {@link #getKeepAliveInterval()}
   */
  @Deprecated
  ...
  /**
   * @deprecated instead use {@link #setKeepAliveInterval(int)}
   */
  @Deprecated
  public MqttClientOptions setKeepAliveTimeSeconds(int keepAliveInterval) {
