...
----
compile io.vertx:vertx-mqtt:3.6.0-SNAPSHOT
----
...
`link:../../jsdoc/module-vertx-mqtt-js_mqtt_server-MqttServer.html[MqttServer]` instance is created and the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_server-MqttServer.html#endpointHandler[endpointHandler]` method is used to specify the handler called
when a remote client sends a CONNECT message for connecting to the server itself. The `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html[MqttEndpoint]`
...
Inside that handler, the _endpoint_ instance provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#accept[accept]` method
for replying to the remote client with the corresponding CONNACK message : in this way, the connection is established.
Finally, the server is started using the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_server-MqttServer.html#listen[listen]` method with
...
The same _endpoint_ instance provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#disconnectHandler[disconnectHandler]`
...
using the SUBSCRIBE message. The `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html[MqttEndpoint]` interface allows to specify an handler for the
incoming subscription request using the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#subscribeHandler[subscribeHandler]` method.
Such handler receives an instance of the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_subscribe_message-MqttSubscribeMessage.html[MqttSubscribeMessage]` interface which brings
the list of topics with related QoS levels as desired by the client.
Finally, the endpoint instance provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#subscribeAcknowledge[subscribeAcknowledge]` method
...
In the same way, it's possible to use the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#unsubscribeHandler[unsubscribeHandler]` method
...
an instance of the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_unsubscribe_message-MqttUnsubscribeMessage.html[MqttUnsubscribeMessage]` interface as parameter with the list of topics to unsubscribe.
Finally, the endpoint instance provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#unsubscribeAcknowledge[unsubscribeAcknowledge]` method
...
In order to handle incoming messages published by the remote client, the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html[MqttEndpoint]` interface provides
the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishHandler[publishHandler]` method for specifying the handler called
when the client sends a PUBLISH message. This handler receives an instance of the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_publish_message-MqttPublishMessage.html[MqttPublishMessage]`
...
available `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishAcknowledge[publishAcknowledge]` method.

If the QoS level is 2 (EXACTLY_ONCE), the endpoint needs to reply with a PUBREC message using the
available `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishReceived[publishReceived]` method; in this case the same endpoint should handle
...
and it can do that specifying the handler through the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishReleaseHandler[publishReleaseHandler]` method.
In order to close the QoS level 2 delivery, the endpoint can use the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishComplete[publishComplete]` method
...
`link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publish[publish]` method
...
in order to receive final acknowledge of delivery. It's possible using the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishAcknowledgeHandler[publishAcknowledgeHandler]` method
...
The `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishReceivedHandler[publishReceivedHandler]` method allows to specify
the handler for that. Inside that handler, the endpoint can use the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishRelease[publishRelease]` method
...
as final acknowledge for the published message; it's possible using the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#publishCompletionHandler[publishCompletionHandler]`
...
Even if there is no need for the high level application to handle that, the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html[MqttEndpoint]` interface
provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_endpoint-MqttEndpoint.html#pingHandler[pingHandler]` method for specifying an handler
...
The `link:../../jsdoc/module-vertx-mqtt-js_mqtt_server-MqttServer.html[MqttServer]` interface provides the `link:../../jsdoc/module-vertx-mqtt-js_mqtt_server-MqttServer.html#close[close]` method
...
and calling `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#connect[connect]` and `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#disconnect[disconnect]` methods.
[source,js]
----
...
Here we have the example of usage of `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#subscribe[subscribe]` method. In order to receive messages from rpi2/temp topic we call `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#subscribe[subscribe]` method.
...
As this example shows, handler could be provided via `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#publishHandler[publishHandler]` method.

=== Publishing message to a topic

If you would like to publish some message into topic then `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#publish[publish]` should be called.
...
The right way to keep connection alive is a `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#ping[ping]` method.

IMPORTANT: by default you client keep connections with server automatically. That means that you don't need to call `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#ping[ping]` in order to keep connections with server.
The `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html[MqttClient]` will do it for you.
...
+
You could provide handler by calling `link:../../jsdoc/module-vertx-mqtt-js_mqtt_client-MqttClient.html#publishCompletionHandler[publishCompletionHandler]`. The handler will be called each time publish is completed.
